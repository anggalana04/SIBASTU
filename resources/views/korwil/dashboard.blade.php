...
<div class="dashboard-korwil-container modern-dashboard" style="padding:32px 0;display:flex;flex-direction:column;align-items:center;">
    <h1 class="dashboard-title" style="text-align:center;">Dashboard Korwil</h1>
    <div class="dashboard-stats-row" style="display:flex;gap:24px;flex-wrap:wrap;justify-content:center;width:100%;max-width:1200px;">
        <div class="dashboard-stat-card">
            <div class="stat-title">Total Mahasiswa di Korwil</div>
