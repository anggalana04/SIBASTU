...
<div class="dashboard-mhs-main-wrapper">
        ...
        <h1 class="dashboard-mhs-welcome-title">Selamat Datang di SICERDAS!</h1>
        <div class="dashboard-mhs-welcome-desc">
            SICERDAS  adalah platform digital untuk memudahkan mahasiswa dalam mengajukan bantuan dana studi secara transparan, mudah, dan terintegrasi. Silakan lengkapi data, upload berkas, dan pantau proses pengajuan Anda melalui dashboard ini.
        </div>
